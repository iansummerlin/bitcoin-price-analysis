...
class TestPortfolioInit(unittest.TestCase):
    ...
    def test_custom_fees(self):
        p = Portfolio(fee_pct=0.005, slippage_pct=0.001)
...
class TestPortfolioBuy(unittest.TestCase):
    ...
    def test_buy_with_fees(self):
        p = Portfolio(initial_capital=10_000, fee_pct=0.001, slippage_pct=0)
    ...
    def test_buy_with_slippage(self):
        p = Portfolio(initial_capital=10_000, fee_pct=0, slippage_pct=0.001)
        p.execute_buy(50_000, 1_000)
    ...
    def test_buy_records_trade(self):
        ...
        self.assertEqual(p.trades[0]['type'], 'BUY')
...
class TestPortfolioSell(unittest.TestCase):
    ...
    def test_sell_records_trade(self):
        ...
        self.assertEqual(p.trades[1]['type'], 'SELL')
...
class TestPortfolioRoundTrips(unittest.TestCase):
